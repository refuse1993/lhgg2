    ...
    <div class="z-50 bottom-0 h-full w-full">
        <div class="py-2 w-full">
            <div class="flex items-center justify-between">
                ...
                <div @click="isMenu = !isMenu" class="relative">
                    ...
                    <div v-if="isMenu" class="absolute border border-gray-600 right-0 z-20 mt-1 rounded">
                        <button
                            class="flex items-center rounded gap-2 text-red-500 justify-between bg-slate-800 w-full pl-4 pr-3 py-1 hover:bg-gray-900"
                        >
                            <div>Delete</div>
            ...
            <div class="relative flex items-center w-full">
                ...
                <div class="bg-slate-800 rounded-lg w-[calc(100%-50px)] text-sm w-full font-light">
                ...
                <div class="flex items-center">
                    <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
                        <div class="flex gap-0.5">
                            <img class="rounded-full h-[14px] mt-2" src="http://picsum.photos/id/202/50" />
                            <img class="rounded-full h-[17px]" src="http://picsum.photos/id/223/50" />
                        </div>
                        <div class="flex items-center">
                            <img class="rounded-full h-[11px] ml-4" src="http://picsum.photos/id/99/50" />
                        </div>
                    </div>
                </div>
            </div>
