  ...
  <div class="z-50 bottom-0 h-full w-full">
    <div class="py-2 w-full">
      ...
      <div class="relative flex items-center w-full">
        ...
        <div
          class="bg-slate-800 rounded-lg w-[calc(100%-50px)] text-sm w-full font-light"
        >
          ...
          <img
            ...
            :src="
              ...
              (runtimeConfig.public.bucketUrl.endsWith('/') ? '' : '/') +
              post.picture
            "
          />
          ...
          <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
            <div class="flex gap-0.5">
              <img
                ...
                src="http://picsum.photos/id/202/50"
              />
              <img
                class="rounded-full h-[17px]"
                src="http://picsum.photos/id/223/50"
              />
            </div>
            <div class="flex items-center">
              <img
